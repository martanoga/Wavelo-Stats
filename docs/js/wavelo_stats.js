angular.module('myApp', ['nvd3', 'ngMaterial', 'ngMessages'])
    .controller('myCtrl', function ($scope, $http) {
        ...
        $scope.options = {
            ...
            caption: {
                enable: true,
                html: '<div class="graph_caption">Statystyki dostępności i użycia rowerów sieci <a href="https://wavelo.pl">Wavelo</a> w Krakowie. Dane uzyskane za pośrednictwem <a href="https://app.socialbicycles.com/developer/">api</a> udostępnionego przez <a href="http://socialbicycles.com">socialbikes</a>.</div>'
            }
        };
